            ...
            <div className="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
              ...
              >
                ...
                <div className="mt-6 rounded border p-4">
                  ...
                  <input
                    className="mt-2 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 dark:bg-[#1e1f23] dark:text-neutral-100"
                    type="password"
                    value={
                      pluginKeys
